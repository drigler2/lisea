...
public interface IAuthorityRepository {
    ...
    List<IAuthority> queryAll();

    IAuthority queryByAuthorityName(String authorityName);

    Integer countAuthorityByName(String authorityName);

    void updateSingleUserAuthority(String username, IAuthority authority);

    void updateSingleUserAuthority(String username, String authorityName, boolean enabled);

    void insertSingleUserAuthority(String username, String authorityName, boolean enabled)
